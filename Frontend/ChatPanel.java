...
public class ChatPanel extends JPanel {
    ...
    private void loadMessages(String friendName) {
        ...
        // Expected metod: public static List<Message> getMessages(int currentUserId, String friendName)
    ...
    private void handleSendMessage() {
        ...
        if (!txt.isEmpty() && !currentFriendName.isEmpty()) {
            ...
            // Expected metod: public static void sendMessage(int senderId, String receiverName, String content)
    ...
    private void handleRecommendProduct() {
       ...
       // Sample product selection (Normally, a product selection window would open here)
        // For now, we are sending a fixed product
        Product recommendedProduct = new Product("Sony WH-1000XM5", "$299.99", "$349.99");
        
        
        // Expected metod: public static void sendProductRecommendation(int senderId, String receiverName, Product p)
   ...
   //Helper Methods
    ...
    private JPanel createMessageBubble(Message msg) {
        ...
        if (msg.isProduct()) {
            row.add(createProductCard(msg.getSharedProduct()));
        } else {
